...
TEST_RESULT_RECORDER_PATH = rf"{TEST_LOG_PATH}/{TEST_MODEL_NAME}_{TEST_DETECTOR_NAME}_result_recorder.json"
TEST_FINAL_CONFUSION_MATRIX_PATH = rf"{TEST_LOG_PATH}/{TEST_MODEL_NAME}_{TEST_DETECTOR_NAME}_confusion-matrix.json"
